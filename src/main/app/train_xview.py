...
xfile.mkdir("/content/gdrive/Shareddrives/Thesis/result_bert/transformer")
xfile.mkdir("/content/gdrive/Shareddrives/Thesis/result_bert/transformer/predictions")
xfile.mkdir("/content/gdrive/Shareddrives/Thesis/result_bert/transformer/loss")
xfile.mkdir("/content/gdrive/Shareddrives/Thesis/result_bert/transformer/confusion_matrix")
...
class TrainXView:
    def __init__(self, pretrained_path=None):
        ...
        self.logger = {
            "val": setup_logger(name="val_logger",
                                log_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/eval_val.log",
                                level=logging.DEBUG),
            "train": setup_logger(name="train_logger",
                                  log_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/eval_train.log",
                                  level=logging.DEBUG),
            "val_confusion": setup_logger(name="train_confusion_logger",
                                          log_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/confusion_val.log",
                                          level=logging.DEBUG),
            "train_confusion": setup_logger(name="train_confusion_logger",
                                            log_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/confusion_train.log",
                                            level=logging.DEBUG),
    ...
    def __draw_confusion_matrix(self, epoch=-1, full_predictions=None, loader_name='val'):
        ...
        plot_confusion_matrix(
            df_confusion, file_name="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/confusion_matrix/cf_mat_{}_{}.png".format(loader_name, epoch), title="confution matrix "+loader_name)
            ...
            if accuracy > self.best_acc[ln]["value"]:
                ...
                if save_score:
                    with open('{}/epoch{}_{}_predict_vector.pkl'.format(
                            "/content/gdrive/Shareddrives/Thesis/result_bert/transformer/predictions", epoch, ln), 'wb') as f:
    ...
    def train(self):
        ...
        for epoch in range(1, self.num_of_epoch+1):
            ...
            self.evaluate(
                ...
                fail_case_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/result_fail.txt",
                pass_case_file="/content/gdrive/Shareddrives/Thesis/result_bert/transformer/result_pass.txt"
            )
            ...
            if (epoch % 5 == 0 or epoch == self.num_of_epoch):
                ...
                plt.ylabel('loss')
                plt.savefig(
                    "/content/gdrive/Shareddrives/Thesis/result_bert/transformer/loss/losses{}.png".format(epoch))
                torch.save(self.model.state_dict(),
                           "/content/gdrive/Shareddrives/Thesis/result_bert/transformer/model.pt")
