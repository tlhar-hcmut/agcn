...
cfgTrainSequential5 = CfgTrain(
    ...
    num_class       :int = 12
    #common configs
    output_train    = "/content/gdrive/Shareddrives/Thesis/result_train/temporal_stream/batch_aggrigate/update_0514/sequential/eleventh_21h00",
    ...
    ==> add more dense at the last of model SequentialNet
    ==> add weight_decay for optim
...
cfgTrainSequential5_cont = CfgTrain(
...
cfgTrainSequential_changenorm = CfgTrain(
    
    name            = "14_Changenorm_2129",
    desc            =  '''
    batch_size      :int = 10
    pretrained_path :str = None
    num_of_epoch    :int = 200
